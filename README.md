...
[tailscale代码仓库](https://github.com/tailscale/tailscale)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/da532c6d9b964f84a999e877440f1373.png)
...
你需要把这个 JSON 文件变成 Headscale 服务器可以访问的 URL，比如在 Headscale 主机上搭个 Nginx（[nginx配置](https://blog.csdn.net/god_sword_/article/details/129341469)），或者上传到对象存储（比如阿里云 OSS）。
...
参考大佬们的教程：
[Tailscale 基础教程：部署私有 DERP 中继服务器](https://icloudnative.io/posts/custom-derp-servers/#防止-derp-被白嫖)
[headscale保底设施之DERP中继服务器自建](http://junyao.tech/posts/18297f50.html)
